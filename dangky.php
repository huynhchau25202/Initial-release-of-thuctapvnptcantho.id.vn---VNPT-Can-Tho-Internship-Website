...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        ...
        <div class="logo">
            ...
            <a href="index.php"><img src="assets/img/logovnpt.png" alt="" class="img-fluid"></a>
        </div>
                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form">
                            ...
                            <div class="form-group form-button">
                                <button type="submit" name="register" id="signup" class="form-submit mt-4">Đăng Ký</button>
                            </div>
                        </form>
                    </div>
