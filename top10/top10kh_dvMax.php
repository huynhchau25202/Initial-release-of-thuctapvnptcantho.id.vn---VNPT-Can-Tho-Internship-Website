...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    kh.SoDienThoai,
    kh.DiaChi,
    SUM(ttb.SoLuong) AS TongSoGoiDichVu
FROM
...
<div class="content container container-fluid mt-0">
    <div class="card shadow-lg border-0 rounded-lg">
        <div class="card-header bg-primary text-white text-center py-4">
            <h2 class="mb-0"><i class="fas fa-users"></i> Danh Sách Top 10 Khách Hàng Sử Dụng Nhiều Gói Dịch Vụ Nhất
                <?php echo "$message" ?>
            </h2>
        </div>
        <div class="card-body p-5">
                ...
                <table class="table table-hover table-bordered table-striped rounded shadow-sm" id="dataTable">
                    <thead class="bg-primary text-white text-center rounded-top">
                        <tr>
                            ...
                            <th scope="col">Số Gói Dịch Vụ Sử Dụng</th>
                    ...
                    <tbody>
                        ...
                        if (isset($result) && $result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td class='text-center'>" . htmlspecialchars($row['TongSoGoiDichVu']) . "</td>";
                                ...
                                $soLuongDichVu[] = $row['TongSoGoiDichVu'];
                            }
                        } else {
            ...
            if (isset($result) && $result->num_rows > 0) {
                echo '<div class="mt-1">
                        <h2 class="mt-3 mb-3">Biểu đồ Top 10 Khách Hàng Sử Dụng Nhiều Gói Dịch Vụ Nhất ' . $message . ' </h2>
